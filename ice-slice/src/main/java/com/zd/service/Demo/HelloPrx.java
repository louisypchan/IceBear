...
public interface HelloPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default java.util.concurrent.CompletableFuture<java.lang.String> sayHelloAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_sayHelloAsync(java.util.Map<String, String> context, boolean sync)
    {
